  ...
  return (
    <Section id="contact">
      <div className="section-inner" ref={ref}>
        ...
        <h2 className="section-heading contact-heading">Let's create something <span className="gradient-text">extraordinary</span></h2>
        ...
        <div className={`contact-grid-3d ${vis ? 'in-view' : ''}`}>
          <div className="contact-panel contact-panel-left">
            <div className="panel-glow" />
            <div className="contact-links-3d">
              <a href="mailto:vkdeku20@gmail.com" className="contact-card-3d" data-hover>
                <div className="contact-card-icon">
                  <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                </div>
                <div className="contact-card-text">
                  <span className="contact-card-label">Email</span>
                  <span className="contact-card-value">vkdeku20@gmail.com</span>
                </div>
              </a>
              <a href="https://www.linkedin.com/in/waleed-hassan-20438b3a8/" target="_blank" rel="noopener" className="contact-card-3d" data-hover>
                <div className="contact-card-icon">
              ...
              <a href="https://instagram.com/waleed__o16" target="_blank" rel="noopener" className="contact-card-3d" data-hover>
                <div className="contact-card-icon">
                ...
                <div className="contact-card-text">
                  ...
                  <span className="contact-card-value">@waleed__o16</span>
                </div>
              </a>
              <a href="https://github.com/waleed260" target="_blank" rel="noopener" className="contact-card-3d" data-hover>
                <div className="contact-card-icon">
                ...
                <div className="contact-card-text">
                  ...
                  <span className="contact-card-value">@waleed260</span>
                </div>
              </a>
              <a href="https://wa.me/923262233337" target="_blank" rel="noopener" className="contact-card-3d contact-card-whatsapp" data-hover>
                <div className="contact-card-icon">
                ...
                <div className="contact-card-text">
                  ...
                  <span className="contact-card-value">0326 2233337</span>
                </div>
              </a>
            </div>
          </div>
          <div className="contact-panel contact-panel-right">
            <div className="panel-glow" />
            <form className="contact-form-3d" onSubmit={handleSubmit}>
              <div className="form-group-3d">
                <label htmlFor="cf-name" className="form-label-3d">Your Name</label>
                <div className="form-input-wrapper">
                  <span className="form-icon">👤</span>
                  <input id="cf-name" type="text" placeholder="John Doe" value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} required data-hover className="form-input-3d" />
                </div>
              </div>
              <div className="form-group-3d">
                <label htmlFor="cf-email" className="form-label-3d">Email Address</label>
                <div className="form-input-wrapper">
                  <span className="form-icon">📧</span>
                  <input id="cf-email" type="email" placeholder="john@example.com" value={form.email} onChange={e => setForm({ ...form, email: e.target.value })} required data-hover className="form-input-3d" />
                </div>
              </div>
              <div className="form-group-3d">
                <label htmlFor="cf-msg" className="form-label-3d">Your Message</label>
                <div className="form-input-wrapper">
                  <span className="form-icon">💬</span>
                  <textarea id="cf-msg" rows="4" placeholder="Tell me about your project or idea..." value={form.message} onChange={e => setForm({ ...form, message: e.target.value })} required data-hover className="form-input-3d form-textarea-3d" />
                </div>
              </div>
              <button type="submit" className="btn-3d-submit" data-hover>
                <span className="btn-text">{sent ? '✦ Message Sent!' : 'Send Message →'}</span>
